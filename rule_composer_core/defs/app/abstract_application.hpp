...
private:
    ...
    static logger_ptr         create_logger(const std::string& logger_name, spdlog::level::level_enum log_level, const std::string& pattern = logger_constants::DEFAULT_LOG_PATTERN);
};
