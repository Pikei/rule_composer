...
private:
     ...
     * \return A pointer to the current fragment of the JSON file containing the value indicated by the path, or \code nullptr\endcode if the resource was not found.
     */
